...
Also read the changed skill as if you were Claude Code. The description should contain the trigger conditions; the body should contain only the instructions needed after the skill is selected.
