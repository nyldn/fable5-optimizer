...
Inspect the diff, report, or evidence yourself before relaying it. Separate confirmed findings from unverified suggestions. Run important checks Codex skipped. For visual claims, look at the screenshot; do not accept a text-only pass. Do not guess APIs, versions, flags, or package names; verify by reading code or docs before asserting.
